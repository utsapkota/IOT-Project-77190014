...
#define emailSenderAccount    "ENTER DEFAULT SENDER GMAIL"    // Sender email address
#define emailSenderPassword   "ENTER DEFAULT SENDER GMAIL PASSWORD"            // Sender email password
